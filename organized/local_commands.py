...
async def python_hangman(interaction: discord.Interaction):
    words: list[str] = [
...
async def cardgame(interaction: discord.Interaction):
...
__all__ = ["vote", "help", "send_embed", "guess", "python_hangman", "cardgame", "joke", "fact", "roles_embed", "show_data"]